	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 wow fadeInLeft" data-wow-delay=".3s" >
				<img src="{{asset('images/about/about-company.jpg')}}" alt="" class="img-responsive">
			</div>
			<div class="col-md-6">
				<div class="block">
...
<section class="about-feature clearfix">
	<div class="container-fluid">
		<div class="row">
			<div class="block about-feature-1 wow fadeInDown col-md-4 col-xs-12" data-wow-duration="500ms" data-wow-delay=".3s">
				<h2>
					Why Choose Us
				</h2>
				<p>
			...
			<div class="block about-feature-2 wow fadeInDown col-md-4 col-xs-12" data-wow-duration="500ms" data-wow-delay=".5s">
				<h2 class="item_title">
					What You Get
				</h2>
				<p>
			...
			<div class="block about-feature-3 wow fadeInDown col-md-4 col-xs-12" data-wow-duration="500ms" data-wow-delay=".7s">
				<h2 class="item_title">
					Meet The Energy
				</h2>
				<p>
